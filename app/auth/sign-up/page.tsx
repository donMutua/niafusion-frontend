      ...
      <div className="flex w-full flex-col justify-between p-8 lg:w-1/2">
        <div className="flex justify-end">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/sign-in" className="text-[#4F46E5] hover:text-[#4F46E5]/90">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="mx-auto w-full max-w-sm">
          <h1 className="mb-8 text-[clamp(2rem,5vw,3rem)] font-medium leading-tight tracking-tight">Create account</h1>

          <div className="space-y-6">
            <div className="space-y-2">
              <p className="text-sm text-gray-600">Sign up with Open account</p>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Input placeholder="First name" className="h-12 text-base px-4" />
                </div>
                <div>
                  <Input placeholder="Last name" className="h-12 text-base px-4" />
                </div>
              </div>
              <div>
